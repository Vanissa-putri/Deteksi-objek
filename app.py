...
def add_css(dark_mode=False):
    ...
    overlay = "rgba(0, 0, 0, 0.55)" if dark_mode else "rgba(255, 255, 255, 0.8)"
...
def main():
    ...
    # Header
    st.markdown(f"<h1 style='text-align:center; margin-top:-10px;'>{APP_TITLE}</h1>", unsafe_allow_html=True)
